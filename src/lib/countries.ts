export type Country = { name: string; code: string; region: string };

// ISO 3166-1 countries with a coarse region used by the app
export const countries: Country[] = [
  ...
  { name: 'Antigua and Barbuda', code: 'AG', region: 'Latin America' },
  ...
  { name: 'Cuba', code: 'CU', region: 'Latin America' },
  ...
  { name: 'Dominica', code: 'DM', region: 'Latin America' },
  ...
  { name: 'Grenada', code: 'GD', region: 'Latin America' },
  { name: 'Guatemala', code: 'GT', region: 'Latin America' },
  { name: 'Guinea', code: 'GN', region: 'Africa' },
  { name: 'Guinea-Bissau', code: 'GW', region: 'Africa' },
  { name: 'Guyana', code: 'GY', region: 'Latin America' },
  { name: 'Haiti', code: 'HT', region: 'Latin America' },
  { name: 'Honduras', code: 'HN', region: 'Latin America' },
  ...
  { name: 'Jamaica', code: 'JM', region: 'Latin America' },
  ...
  { name: 'Nicaragua', code: 'NI', region: 'Latin America' },
  ...
  { name: 'Panama', code: 'PA', region: 'Latin America' },
  ...
  { name: 'Puerto Rico', code: 'PR', region: 'Latin America' },
  ...
  { name: 'Saint Kitts and Nevis', code: 'KN', region: 'Latin America' },
  { name: 'Saint Lucia', code: 'LC', region: 'Latin America' },
  { name: 'Saint Vincent and the Grenadines', code: 'VC', region: 'Latin America' },
  ...
  { name: 'Suriname', code: 'SR', region: 'Latin America' },
  ...
  { name: 'Trinidad and Tobago', code: 'TT', region: 'Latin America' },
  ...
  { name: 'Venezuela', code: 'VE', region: 'Latin America' },
